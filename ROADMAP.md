...
| 2 — Banners | Full banner feature (admin CRUD/reorder, homepage carousel) | Not started — note: the homepage notification engine (2026-07-19, migration 007) already covers the scrolling text bar; Phase 2 is the image banner carousel only |
